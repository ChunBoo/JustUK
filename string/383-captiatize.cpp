/*
given a string title consisting of one or more words separated by a single space, where each word consists of English letters. Capitalize the string by changing the capitalization of each word such that:
...
int main()
{
    STR ss="eRIC IS rYANS GOOD FRIEND";
    captialLetters(ss);
    std::cout<<ss;
}